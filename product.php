...
$cate= $_GET["cate"];
   ...
   ?>
      ...
      $q= mysqli_query($con,"select * from table_product order by product_id desc limit 8" );
					
		echo'<div class="row">';
		 while($row=mysqli_fetch_array($q,MYSQLI_ASSOC)){
	  echo'<div class="well well-lg col-lg-3 col-md-3 col-sm-3 col-xs-12 border=2" style=" background-color: white; text-align: center; color:maroon;​ ">';			
      echo "<tr>";
